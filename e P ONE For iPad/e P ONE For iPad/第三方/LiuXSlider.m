...
#define SelectViewBgColor   [UIColor colorWithRed:255/255.0 green:255/255.0 blue:255/255.0 alpha:1]
#define defaultViewBgColor  [UIColor colorWithRed:16/255.0 green:45/255.0 blue:108/255.0 alpha:1]
...
//#ifndef IS_IPAD
//#define CenterImage_W       30.0
//#else
//#define CenterImage_W       20.0
//#endif

#define CenterImage_H       10.0

#define LiuXSliderLine_W    (LiuXSlideWidth-50)
...
//        self.backgroundColor=[UIColor colorWithWhite:.6 alpha:.1];
        ...
        _defaultView=[[UIView alloc] initWithFrame:CGRectMake(CenterImage_W/2, LiuXSliderLine_Y, LiuXSlideWidth-CenterImage_W - 25, LiuXSLiderLine_H)];
        ...
        _selectView=[[UIView alloc] initWithFrame:CGRectMake(CenterImage_W/2+0.5, LiuXSliderLine_Y + 0.5, LiuXSlideWidth-CenterImage_W, LiuXSLiderLine_H - 1)];
...
//        if (IS_IPHONE_5) {
//            _selectLab.font=[UIFont systemFontOfSize:10];
//            _selectLab.frame = CGRectMake(0, 30, 50, 20);
//        }
...
-(void)changePointX:(UITouch *)touch{
    ...
    if (point.x<0) {
        _pointX=0;
    }else if (point.x>LiuXSlideWidth - 50){
        _pointX=LiuXSlideWidth - 50;
    }
...
-(void)refreshSlider{
    ...
    if (_sectionIndex==0) {
        _leftLab.hidden=YES;
        _selectLab.center=CGPointMake(_pointX, 2);
